    ...
    <>
      ...
      <Grid container sx={{alignItems : 'center'}}>
        <Grid item xs={12} xl={3} sx={{display : 'flex', flexDirection : 'column', justifyContent : 'center', alignItems : 'center'}}>
             <Image src={Logo} onClick={()=> router.push(`${mainUrl}`)} alt='ديفا' width={140} style={{marginBottom : '20px'}} loading='lazy'/>
          <Typography variant='body1' sx={{color : '#808080', lineHeight : '40px', fontSize : '15px', textAlign : 'center'}}>
        ...
        <Grid item xs={12} xl={3} sx={{padding : '0px 40px'}}>
            <Typography className='footer-titles' variant='h5' sx={{fontSize : '20px', marginBottom : '40px',fontWeight : 'bold', textAlign : 'center', position : 'relative', marginTop : {xs : '30px', lg : '0'}}}>الصفحات  الرئيسية</Typography>
            {mainPage.map((item)=>{
              return (
        ...
        <Grid item xs={12} xl={3} sx={{padding : '0px 40px'}}>
                 ...
                 <Typography className='footer-titles' variant='h5' sx={{fontSize : '20px', fontWeight : 'bold', textAlign : 'center', position : 'relative',  marginBottom : '40px', marginTop : {xs : '10px', lg : '0'}}}>الصفحات  الداخلية</Typography>
                   {mainPage.map((item)=>{
                return (
                <Box key={item.id}>
                        <ul>
        ...
        <Typography className='footer-titles' variant='h5' sx={{fontSize : '20px', fontWeight : 'bold', textAlign : 'center', position : 'relative',  marginTop : {xs : '10px', lg : '0'}}}>الصفحات  الداخلية</Typography>
      ...
      display : 'flex', justifyContent : 'center', alignItems : 'center'
            ...
            <Container maxWidth="xxl" fixed>
              ...
              <Typography variant='h4' style={{color : '#fff', fontSize : '20px', marginLeft : '10px'}}>
